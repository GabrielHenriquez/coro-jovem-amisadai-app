...
export interface PresenceComponentWithCount {
...
const presenceComponentsHtmlContent = (data: PresenceComponentsData) => {
  return `<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    <title>Frequência de Presenças - Coro Jovem Amisadai</title>
    <style>
        body {
        ...
        .presence-count {
            color: #4CAF50;
            font-weight: bold;
            white-space: nowrap; /* deixa o número + "presenças" juntinhos */
        }
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h2>Relatório de Frequência de Presenças - ${data.month} de ${data.year}</h2>
            <p class="header-info">
        ...
        <div class="summary">
            ...
            <p><strong>Total de Presenças Registradas:</strong> ${
        ...
        ${
          data.totalPresent > 0
            ? `
        <div class="section-title">Componentes com Presenças (Ordenados por Maior Frequência)</div>
        ...
        <div class="summary">
            <p>Não há presenças registradas para este mês.</p>
        </div>
        `
        }
...
export default presenceComponentsHtmlContent;
