...
} from "./missingComponentsHtmlContent";
...
const annualMissingComponentsHtmlContent = (data: MissingComponentsData) => {
  return `<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    <title>Relatório Anual de Faltas - Coro Jovem Amisadai</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h2>Relatório Anual de Faltas - ${data.year}</h2>
            <p class="header-info">
        ...
        <div class="summary">
            ...
            <p><strong>Total de Componentes com Faltas:</strong> ${
              data.totalMissing
            }</p>
            ...
            <p><strong>Total de Faltas Registradas no Ano:</strong> ${
        ...
        ${
          data.totalMissing > 0
            ? `
        <div class="section-title">Componentes com Faltas no Ano (Ordenados por Maior Quantidade)</div>
        ...
        <div class="summary">
            <p>Parabéns! Não há componentes faltosos registrados para este ano.</p>
        </div>
        `
        }
...
export default annualMissingComponentsHtmlContent;
